...
## Routes / screens used
- `PametniSistemCakalnice-main/docs/screenshots/02-dashboard.png` → shown as `queue.clinic.app`
- `PametniSistemCakalnice-main/docs/screenshots/05-cakalne-vrste.png` → shown as `queue.clinic.app/queues`
- `PametniSistemCakalnice-main/docs/screenshots/06-javni-zaslon.png` → shown as `queue.clinic.app/display`
- Mobile: `PametniSistemCakalnice-main/docs/screenshots/10-mobilni-prikaz.png`
...
- `videos/01-instagram-reel.mp4` (6.2 MB)
- `videos/02-tiktok.mp4` (6.2 MB)
- `videos/03-youtube-short.mp4` (6.2 MB)
- `videos/04-linkedin-demo.mp4` (13.3 MB)
- `videos/05-x-demo.mp4` (9.6 MB)
- `videos/06-facebook-demo.mp4` (13.2 MB)
- `videos/07-github-readme-demo.mp4` (6.7 MB)
- `videos/08-portfolio-hero.mp4` (13.2 MB)
- `videos/gifs/github-readme-demo.gif` (6.5 MB)
- `videos/gifs/short-demo.gif` (8.8 MB)
...
**Screens/routes used:** Dashboard, Queues, Public display + mobile view.
